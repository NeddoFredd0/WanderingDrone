local assets=
{
    Asset("ANIM", "anim/fx_sysrestoregear.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("fx_sysrestoregear")
    inst.AnimState:SetBuild("fx_sysrestoregear")
...
return Prefab("common/inventory/fx_sysrestoregear", fn, assets)
