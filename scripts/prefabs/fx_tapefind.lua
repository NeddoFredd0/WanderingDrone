local assets=
{
    Asset("ANIM", "anim/fx_tapefind.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("fx_tapefind")
    inst.AnimState:SetBuild("fx_tapefind")
	...
	--inst.SoundEmitter:PlaySound("sound/dontstarve_shipwreckedSFX/DSS_loot_reveal")
...
return Prefab("common/inventory/fx_tapefind", fn, assets)
