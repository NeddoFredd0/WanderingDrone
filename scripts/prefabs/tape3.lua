local assets=
{
    Asset("ANIM", "anim/tape3.zip"),

    Asset("ATLAS", "images/inventoryimages/tape3.xml"),
    Asset("IMAGE", "images/inventoryimages/tape3.tex"),
}
...
SetSharedLootTable('tape3loot',
{
	{"tapebits_3", 1.00},  --mechanical bits
	{"tapebits_1", 0.33},  --magnetic tape
	{"tapebits_2", 0.05},  --shell
	{"tapebits_busted", 0.5},
	{"tapebits_busted", 0.25},
	{"trinket_6", 0.03}, --frazzled wires
	{"trinket_27", 0.01}, --wire coat hanger
})
...
local function fn()
    ...
    inst.AnimState:SetBank("tape3")
    inst.AnimState:SetBuild("tape3")
    ...
    inst.components.inventoryitem.imagename = "tape3"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/tape3.xml"
...
--STRINGS.NAMES.TAPE3 = "Remembrance"
	...
	inst.components.lootdropper:SetChanceLootTable('tape3loot')
...
return  Prefab("common/inventory/tape3", fn, assets, prefabs)